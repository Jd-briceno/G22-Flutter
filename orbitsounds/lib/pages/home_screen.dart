...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _scheduleReminderNotification(); // 🔔 AÑADE ESTO
      });
    }
  ...
  Future<void> _scheduleReminderNotification() async {
    ...
    await notificationService.flutterLocalNotificationsPlugin.zonedSchedule(
      0,
      'Hey, don’t forget your Longbook',
      'Tap here to log your emotions 🎧',
      tz.TZDateTime.now(tz.local).add(const Duration(seconds: 20)), // ⬅️ ESTA ES LA LÍNEA CORRECTA
      const NotificationDetails(
        android: AndroidNotificationDetails(
          'reminder_channel',
          'Longbook Reminders',
          channelDescription: 'Recordatorios para usar la Longbook',
        ...
        children: [
          ...
          Positioned(
            ...
            child: FloatingActionButton(
              ...
              elevation: 8,
              onPressed: () {
                print("🧠 Sesión iniciada (modo AI/recommendation)");
                FirebaseAnalytics.instance.logEvent(name: 'session_started', parameters: {
    ...
    return ShortcutsContainer(
      shortcuts: [
        ShortcutItem(
          ...
          onTap: () {
            print("🚀 Sesión iniciada (modo manual)");
            FirebaseAnalytics.instance.logEvent(name: 'session_started', parameters: {
              'mode': 'manual',
            });
            Navigator.push(
